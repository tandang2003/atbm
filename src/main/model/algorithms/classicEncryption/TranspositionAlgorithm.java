...
import main.model.key.CharacterKey;
...
//    IKey<Map<Integer, String>> keys;
    ...
    public TranspositionAlgorithm(String keys, List<String> chars) {
    ...
    public static void main(String[] args) {
        TranspositionAlgorithm algorithm = new TranspositionAlgorithm(Alphabet.VIETNAMESE_CHAR_SET);
        algorithm.genKey();
